        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-10">
              <Link to="/all-requests" state={{ filter: "ALL" }} className="block focus:outline-none">
                <LeaveCard
              ...
              <Link to="/all-requests" state={{ filter: "PENDING" }} className="block focus:outline-none">
                <LeaveCard
              ...
              <Link to="/all-requests" state={{ filter: "APPROVED" }} className="block focus:outline-none">
                <LeaveCard
              ...
              <Link to="/all-requests" state={{ filter: "REJECTED" }} className="block focus:outline-none">
                <LeaveCard
